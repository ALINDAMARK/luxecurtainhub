...
<div class="page-shell">
    ...
    <section class="section" id="collection">
        <div class="section-head">
            ...
            <a class="cta cta-secondary" href="<?php echo e(route('products')); ?>">View all products</a>
        </div>
        <div class="card-grid">
            <?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="product-card js-product-card" tabindex="0"
                    ...
                    <div class="body">
                        <div class="meta"><?php echo e($product['category']); ?></div>
                        <h3><?php echo e($product['name']); ?></h3>
                        <?php if(!empty($product['description'])): ?>
                            <p style="line-height:1.8;color:#5b4a40;margin-top:.85rem;"><?php echo e($product['description']); ?></p>
                        <?php endif; ?>
                    </div>
                </article>
    ...
    <section class="section">
        <div class="split">
            <div class="feature-image">
                <img src="<?php echo e($featuredImageUrl ?? 'https://i.pinimg.com/736x/58/9f/92/589f92fba7423b01456d998ff1718eb5.jpg'); ?>" alt="Featured curtain interior" loading="lazy">
            </div>
        ...
        <div class="gallery-grid">
            <?php $__currentLoopData = $lookbookImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="gallery-card js-gallery-card" tabindex="0"
                    ...
                    data-category="<?php echo e($image['caption'] ?? $image['title']); ?>"
                    data-description="<?php echo e($image['alt_text']); ?>">
                    <img src="<?php echo e($image['image_url']); ?>" alt="<?php echo e($image['alt_text']); ?>" loading="lazy">
                    <div class="gallery-caption">
                        <div class="meta"><?php echo e($image['caption'] ?? $image['title']); ?></div>
                    </div>
                </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="card-grid">
            <?php $__currentLoopData = $successStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="story-card">
                    <img src="<?php echo e($story['image_url'] ?? 'https://i.pinimg.com/736x/87/79/54/877954c4a6f8f6549608182d802d1d2b.jpg'); ?>" alt="<?php echo e($story['client_name']); ?> story" loading="lazy">
                    <div class="body">
                        <div class="meta"><?php echo e($story['client_name']); ?> · <?php echo e($story['location']); ?></div>
                        <h3><?php echo e($story['quote']); ?></h3>
                        <p style="color:#5b4a40;line-height:1.8;"><?php echo e($story['story']); ?></p>
                    </div>
                </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <section class="section" id="contact">
        ...
        <div class="contact-wrap">
            ...
            <form class="form-grid" action="<?php echo e(route('consultation.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="fg">
...
$message = $__bag->first($__errorArgs[0]); ?> <div style="margin-top:.45rem;color:#b35c47;font-size:.72rem;"><?php echo e($message); ?></div> <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MARK ARINDA\Desktop\LuxeCurtainHub\resources\views/home.blade.php ENDPATH**/ ?>